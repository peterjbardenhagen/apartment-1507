...
const actions = [
  ...
  {
    title: 'Messages',
    desc: 'Message your flatmates, your landlord, or everyone',
    cta: 'Open messages',
    path: '/flatmate/messages',
    tile: 'bg-teal-100 text-teal-700',
    icon: 'M8 10h.01M12 10h.01M16 10h.01M9 16H5a2 2 0 01-2-2V6a2 2 0 012-2h14a2 2 0 012 2v8a2 2 0 01-2 2h-5l-5 5v-5z'
  },
  {
    title: 'Contacts',
    desc: "Everyone's contact details",
    cta: 'View contacts',
    path: '/flatmate/contacts',
    tile: 'bg-slate-100 text-slate-600',
    icon: 'M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z'
  },
  {
    title: 'Medical & Health',
    desc: 'Hospitals, GP clinics and home doctors nearby',
    cta: 'Find care',
